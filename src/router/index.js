...
// DN Individu
const DNIndividuProfile = () =>
  import("../pages/dn-individu/profile/create/CreateProfile.vue");
const DNIndividuLegalitas = () =>
  import("../pages/dn-individu/legalitas/create/CreateLegalitas.vue");
const DNIndividuOperasional = () =>
  import(
    "../pages/dn-individu/operasional/create/struktur-usaha/CreateStrukturUsaha.vue"
  );
const DNIndividuPasar = () =>
  import(
    "../pages/dn-individu/pasar/create/jaringan-distribusi/CreateJaringanDistribusi.vue"
  );
const DNIndividuStatusVerifikasiDokumen = () =>
  import("../pages/dn-individu/StatusVerifikasiDokumen.vue");
const DNIndividuKeuangan = () =>
  import(
    "../pages/dn-individu/keuangan/create/tipe-pembayaran/CreateTipePembayaran.vue"
  );

// DN Distributor
const DNDistributorDataVerification = () =>
  import("../pages/dn-distributor/distributor-data-verification/index.vue");
const DNDistributorProfile = () =>
  import("../pages/dn-distributor/profile/create/CreateProfile.vue");
const DNDistributorLegalitas = () =>
  import("../pages/dn-distributor/legalitas/create/npwp/CreateNpwp.vue");
const DNDistributorPasar = () =>
  import(
    "../pages/dn-distributor/pasar/create/jaringan-distribusi/CreateJaringanDistribusi.vue"
  );
const DNDistributorOperasional = () =>
  import(
    "../pages/dn-distributor/operasional/create/struktur-organisasi/CreateStrukturOrganisasi.vue"
  );
const DNDistributorKeuangan = () =>
  import(
    "../pages/dn-distributor/keuangan/create/tipe-pembayaran/CreateTipePembayaran.vue"
  );
const DNDistributorInformasiCabang = () =>
  import(
    "../pages/dn-distributor/informasi-cabang/create/CreateInformasiCabang.vue"
  );

// DN Korporasi
const DNKorporasiProfile = () =>
  import("../pages/dn-korporasi/profile/create/CreateProfile.vue");
const DNKorporasiLegalitas = () =>
  import("../pages/dn-korporasi/legalitas/create/npwp/CreateNpwp.vue");
const DNKorporasiPasar = () =>
  import(
    "../pages/dn-korporasi/pasar/create/jaringan-distribusi/CreateJaringanDistribusi.vue"
  );
const DNKorporasiOperasional = () =>
  import(
    "../pages/dn-korporasi/operasional/create/struktur-organisasi/CreateStrukturOrganisasi.vue"
  );
const DNKorporasiKeuangan = () =>
  import(
    "../pages/dn-korporasi/keuangan/create/tipe-pembayaran/CreateTipePembayaran.vue"
  );
const DNKorporasiInformasiCabang = () =>
  import(
    "../pages/dn-korporasi/informasi-cabang/create/CreateInformasiCabang.vue"
  );

// LN Korporasi
const LNKorporasiProfile = () =>
  import("../pages/ln-korporasi/profile/create/CreateProfile.vue");
const LNKorporasiLegalitas = () =>
  import("../pages/ln-korporasi/legalitas/create/tin/CreateTIN.vue");
const LNKorporasiPasar = () =>
  import(
    "../pages/ln-korporasi/pasar/create/jaringan-distribusi/CreateMarket.vue"
  );
const LNKorporasiOperasional = () =>
  import(
    "../pages/ln-korporasi/operasional/create/struktur-organisasi/CreateStrukturOrganisasi.vue"
  );
const LNKorporasiKeuangan = () =>
  import(
    "../pages/ln-korporasi/keuangan/create/tipe-pembayaran/CreateTipePembayaran.vue"
  );

// LN Agen
const LNAgenProfile = () =>
  import("../pages/ln-agen/profile/create/profile/CreateProfile.vue");
const LNAgenLegalitas = () =>
  import("../pages/ln-agen/legalitas/create/npwp/CreateNpwp.vue");
const LNAgenOperasional = () =>
  import(
    "../pages/ln-agen/operasional/create/struktur-organisasi/CreateStrukturOrganisasi.vue"
  );
const LNAgenKeuangan = () =>
  import(
    "../pages/ln-agen/keuangan/create/tipe-pembayaran/CreateTipePembayaran.vue"
  );

// DN Retail Korporasi
const DNRetailKorporasiProfile = () =>
  import("../pages/dn-retail-korporasi/profile/create/CreateProfile.vue");
const DNRetailKorporasiLegalitas = () =>
  import("../pages/dn-retail-korporasi/legalitas/create/npwp/CreateNpwp.vue");
const DNRetailKorporasiPasar = () =>
  import(
    "../pages/dn-retail-korporasi/pasar/create/jaringan-distribusi/CreateJaringanDistribusi.vue"
  );
const DNRetailKorporasiOperasional = () =>
  import(
    "../pages/dn-retail-korporasi/operasional/create/struktur-organisasi/CreateStrukturOrganisasi.vue"
  );
const DNRetailKorporasiKeuangan = () =>
  import(
    "../pages/dn-retail-korporasi/keuangan/create/tipe-pembayaran/CreateTipePembayaran.vue"
  );
const DNRetailKorporasiInformasiCabang = () =>
  import(
    "../pages/dn-retail-korporasi/informasi-cabang/create/CreateInformasiCabang.vue"
  );

// DN Cabang
const DNCabangProfile = () => 
  import("../pages/dn-cabang/profile/create/CreateProfile.vue");
const DNCabangLegalitas = () =>
  import("../pages/dn-cabang/legalitas/create/npwp/CreateNpwp.vue");
const DNCabangPasar = () =>
  import(
    "../pages/dn-cabang/pasar/create/jaringan-distribusi/CreateJaringanDistribusi.vue"
  );
const DNCabangOperasional = () =>
  import(
    "../pages/dn-cabang/operasional/create/struktur-organisasi/CreateStrukturOrganisasi.vue"
  );
const DNCabangKeuangan = () =>
  import(
    "../pages/dn-cabang/keuangan/create/tipe-pembayaran/CreateTipePembayaran.vue"
  );
const DNCabangInformasiCabang = () =>
  import(
    "../pages/dn-cabang/informasi-cabang/create/CreateInformasiCabang.vue"
  );
...
const routes = [
  ...
  },
  {
    ...
    beforeEnter: (to, from, next) => {
      if (localStorage.getItem("user-state")) {
        ...
        } else if (userState === "data-individu") {
          next({
            name: "dn-individu.profile",
          });
        } else if (userState === "data-distributor") {
          next({
    ...
    children: [
      {
        ...
        beforeEnter: (to, from, next) => {
          if (localStorage.getItem("user-state")) {
            ...
            next(); // if user come from login page then redirect immadiately to this page. 
          }
        },
      },
    ],
    ...
    children: [
      {
        ...
        beforeEnter: (to, from, next) => {
          if (localStorage.getItem("user-state")) {
            const userState = localStorage.getItem("user-state");
            if (userState === 'kuisioner-page' || userState === 'verifikasi-page') {
  ...
  },
  {
    ...
    children: [
      {
        path: "/verifikasi/data-verification",
        name: "dn-distributor.data-verification",
        component: DNDistributorDataVerification,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      {
        path: "/dn-cabang/profile",
        name: "dn-cabang.profile",
        component: DNCabangProfile,
      },
      {
        path: "/dn-cabang/legalitas",
        name: "dn-cabang.legalitas",
        component: DNCabangLegalitas,
      },
      {
        path: "/dn-cabang/pasar",
        name: "dn-cabang.pasar",
        component: DNCabangPasar,
      },
      {
        path: "/dn-cabang/operasional",
        name: "dn-cabang.operasional",
        component: DNCabangOperasional,
      },
      {
        path: "/dn-cabang/keuangan",
        name: "dn-cabang.keuangan",
        component: DNCabangKeuangan,
      },
      {
        path: "/dn-cabang/informasi-cabang",
        name: "dn-cabang.informasi-cabang",
        component: DNCabangInformasiCabang,
      },
    ],
  },
  {
