...
export default function useBundleItemApproval(itemType) {
    ...
    // provide("approveBundleItem", approveBundleItem);
    // provide("rejectBundleItem", rejectBundleItem);
    // provide("proposeBundleItemRevision", proposeBundleItemRevision);
    // provide("bundleItem", bundleItem);
    // provide("bundleItemStatus", bundleItemStatus);
