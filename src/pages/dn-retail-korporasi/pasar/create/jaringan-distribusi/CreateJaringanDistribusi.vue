<template>
  <div class="grid grid-cols-12 gap-6">
    <DNNav />
    <!-- Jaringan distribusi / Pengecer -->
    <div class="intro-y col-span-12 lg:col-span-8">
      <document-form
        title="Jaringan Distribusi / Pengecer"
        v-loading="loading"
        :itemType="2"
      >
        <div>
            ...
            <div class="grid grid-cols-12 gap-5">
              <div class="col-span-6">
                <form-item
                  ...
                  label="Nama Kios"
                  rules-text="Required"
                  :validationData="validate.nama_kios"
                >
                  <input
                    v-model="validate.nama_kios.$model"
                    placeholder="Nama Kios"
                    class="form-control"
                    :class="{
                      'border-theme-6': validate.nama_kios.$error,
                    }"
                  />
                </form-item>
              </div>
              <div class="col-span-6">
                <form-item
                  ...
                  label="PIC"
                  rules-text="Required"
                  :validationData="validate.pic"
                >
                  <input
                    v-model="validate.pic.$model"
                    placeholder="PIC"
                    class="form-control"
                    :class="{
                      'border-theme-6': validate.pic.$error,
                    }"
                  />
                </form-item>
              </div>
              ...
              <div class="col-span-6">
                <form-item
                  ...
                  label="Alamat Kios"
                  rules-text="Required"
                  :validationData="validate.alamat_kios"
                >
                  <input
                    v-model="validate.alamat_kios.$model"
                    placeholder="Alamat Kios"
                    class="form-control"
                    :class="{
                      'border-theme-6': validate.alamat_kios.$error,
                    }"
                  />
                </form-item>
              </div>
    ...
    <!-- End Jaringan distribusi / Pengecer -->
...
import Kendaraan from "../kendaraan/CreateKendaraan.vue";
import Gudang from "../gudang/CreateGudang.vue";
...
export default defineComponent({
  components: { DocumentForm, DataGrid, FormItem, DNNav, Kendaraan, Gudang },
  setup() {
