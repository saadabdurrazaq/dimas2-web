<template>
  ...
  <div class="intro-y col-span-12 lg:col-span-8">
    <!-- BEGIN: Form Gudang -->
    <document-form title="Gudang" v-loading="loading" :itemType="2">
      <div class="pt-5">
        <div class="grid grid-cols-12 gap-5">
          <div class="col-span-6">
            <form-item
              ...
              label="Nama Gudang"
              rules-text="Required"
              :validationData="validate.nama_gudang"
            >
              <input
                v-model="validate.nama_gudang.$model"
                placeholder="Nama Gudang"
                class="form-control"
                :class="{
                  'border-theme-6': validate.nama_gudang.$error,
                }"
              />
            </form-item>
          </div>
          <div class="col-span-6">
            <form-item
              ...
              label="Status Gudang"
              rules-text="Required"
              :validationData="validate.status_gudang"
            >
              <input
                v-model="validate.status_gudang.$model"
                placeholder="Status Gudang"
                class="form-control"
                :class="{
                  'border-theme-6': validate.status_gudang.$error,
                }"
              />
            </form-item>
          </div>
          <div class="col-span-6">
            <form-item
              ...
              label="Luas Gudang"
              rules-text="Required"
              :validationData="validate.luas_gudang"
            >
              <input
                v-model="validate.luas_gudang.$model"
                placeholder="Luas Gudang"
                class="form-control"
                :class="{
                  'border-theme-6': validate.luas_gudang.$error,
                }"
              />
            </form-item>
          </div>
          <div class="col-span-6">
            <form-item
              ...
              rules-text="Required"
              :validationData="validate.kapasitas_gudang"
            >
              <input
                v-model="validate.kapasitas_gudang.$model"
                placeholder="Kapasitas Gudang"
                class="form-control"
                :class="{
                  'border-theme-6': validate.kapasitas_gudang.$error,
                }"
              />
            </form-item>
          </div>
        </div>
        <div class="grid grid-cols-1 gap-5 pt-5 pb-5">
          <form-item
            class="intro-y"
            label="Alamat Gudang"
            rules-text="Required"
            :validationData="validate.alamat_gudang"
          >
            <textarea
              v-model="validate.alamat_gudang.$model"
              placeholder="Alamat Gudang"
              class="form-control"
              :class="{
                'border-theme-6': validate.alamat_gudang.$error,
              }"
            />
          </form-item>
        </div>
        <div class="grid grid-cols-12 gap-5">
          ...
          <div class="col-span-3">
            <form-item
              ...
              label="Latitude"
              rules-text="Required"
              :validationData="validate.latitude"
            >
              <input
                v-model="validate.latitude.$model"
                placeholder="Latitude"
                class="form-control"
                :class="{
                  'border-theme-6': validate.latitude.$error,
                }"
              />
            </form-item>
          </div>
          <div class="col-span-3">
            <form-item
              ...
              label="Longitude"
              rules-text="Required"
              :validationData="validate.longitude"
            >
              <input
                v-model="validate.longitude.$model"
                placeholder="Longitude"
                class="form-control"
                :class="{
                  'border-theme-6': validate.longitude.$error,
                }"
              />
            </form-item>
          </div>
          <div class="col-span-6">
            <form-item
              ...
              label="Foto Gudang"
              rules-text="Required"
              :validationData="validate.foto_gudang"
            >
              <el-upload
                ref="elUpload"
