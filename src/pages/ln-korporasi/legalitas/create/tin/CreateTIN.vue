<template>
  <div class="grid grid-cols-12 gap-6">
    ...
    <div class="col-span-12 xl:col-span-8">
      <!-- Start: TIN (Tax Identity Number) -->
      <document-form title="TIN (Tax Identity Number)" v-loading="legalitasLoading">
        <div class="pb-5 pt-3">
          <div class="grid grid-cols-12 gap-5">
            <div class="col-span-6">
              <form-item
                ...
                rules-text="Required"
                :validationData="validate.holding_number"
              >
                <input
                  v-model="validate.holding_number.$model"
                  placeholder="Holding Number"
                  class="form-control"
                  :class="{
                    'border-theme-6': validate.holding_number.$error,
                  }"
                />
              </form-item>
            </div>
...
export default defineComponent({
  components: { DocumentForm, FormItem, DNNav, LegalitasPerusahaan, SuratPernyataan},
  setup() {
