<template>
  <document-form title="Legality of Company" v-loading="legalitasLoading">
    <div class="pb-5 pt-3">
      <div class="grid grid-cols-12 gap-5">
        <div class="col-span-6">
          <form-item
            ...
            rules-text="Required"
            :validationData="validate.representative_number"
          >
            <input
              v-model="validate.representative_number.$model"
              placeholder="Representative Number"
              class="form-control"
              :class="{
                'border-theme-6': validate.representative_number.$error,
              }"
            />
          </form-item>
        </div>
        ...
        <div class="col-span-6">
          <form-item
            ...
            rules-text="Required"
            :validationData="validate.business_license"
          >
            <input
              v-model="validate.business_license.$model"
              placeholder="Business License"
              class="form-control"
              :class="{
                'border-theme-6': validate.business_license.$error,
              }"
            />
          </form-item>
        </div>
