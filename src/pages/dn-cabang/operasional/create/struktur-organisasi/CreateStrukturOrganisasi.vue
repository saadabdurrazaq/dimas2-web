            ...
            <div class="grid grid-cols-12 gap-5">
              <div class="col-span-6">
                <form-item
                  ...
                  rules-text="Required"
                  :validationData="validate.struktur_pemegang_saham"
                >
                  <el-upload
                    ref="elUpload"
              ...
              <div class="col-span-6">
                <form-item
                  ...
                  rules-text="Required"
                  :validationData="validate.company_profile"
                >
                  <el-upload
                    ref="elUpload"
                    class="upload-demo form-control"
              ...
              <div class="col-span-6">
                <form-item
                  ...
                  label="Bukti Fisik" 
                  rules-text="Required"
                  :validationData="validate.bukti_fisik"
                >
                  <el-upload
                    ref="elUpload"
                    class="upload-demo form-control"
...
import TenagaPemasaran from "../tenaga-pemasaran/CreateTenagaPemasaran.vue";
import Direksi from "../direksi/CreateDireksi.vue";
import PemegangSaham from "../pemegang-saham/CreatePemegangSaham.vue";
import PicPerusahaan from "../pic-perusahaan/CreatePicPerusahaan.vue";
...
export default defineComponent({
  components: { DocumentForm, DataGrid, FormItem, DNNav, TenagaPemasaran, Direksi, PemegangSaham, PicPerusahaan },
  setup() {
    const formData = reactive({ ...formDataDefaults });
    const rules = {
      struktur_pemegang_saham: { required },
