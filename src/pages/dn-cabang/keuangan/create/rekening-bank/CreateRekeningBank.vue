<template>
  ...
  <div class="intro-y col-span-12 lg:col-span-8">
    <!-- BEGIN: Form Rekening Bank -->
    <document-form title="Rekening Bank" v-loading="loading" :itemType="2">
      <div>
        <div class="p-5">
          <div class="grid grid-cols-2 gap-5">
            <form-item
              ...
              label="Nama Bank" 
              rules-text="Required"
              :validationData="validate.nama_bank"
            >
              <input
                v-model="validate.nama_bank.$model"
                placeholder="Nama Bank"
                class="form-control"
                :class="{
                  'border-theme-6': validate.nama_bank.$error,
                }"
              />
            </form-item>
            <form-item
              ...
              label="Cabang" 
              rules-text="Required"
              :validationData="validate.cabang"
            >
              <input
                v-model="validate.cabang.$model"
                placeholder="Cabang"
                class="form-control"
                :class="{
                  'border-theme-6': validate.cabang.$error,
                }"
              />
            </form-item>
            <form-item
              ...
              rules-text="Required"
              :validationData="validate.nomor_rekening"
            >
              <input
                v-model="validate.nomor_rekening.$model"
                placeholder="Nomor Rekening"
                class="form-control"
                :class="{
                  'border-theme-6': validate.nomor_rekening.$error,
                }"
              />
            </form-item>
            <form-item
              class="intro-y"
              label="Bukti Fisik Rekening" 
              rules-text="Required"
              :validationData="validate.bukti_fisik_rekening"
            >
              <el-upload
                ref="elUpload"
