<template>
  <document-form title="Tenaga Pemasaran" v-loading="loading" :itemType="2">
    <div>
      <div class="p-5">
        <div class="grid grid-cols-2 gap-5">
          <form-item
            ...
            label="Nama"
            rules-text="Required"
            :validationData="validate.nama"
          >
            <input
              v-model="validate.nama.$model"
              placeholder="Nama"
              class="form-control"
              :class="{
                'border-theme-6': validate.nama.$error,
              }"
            />
          </form-item>
          <form-item
            ...
            label="Jabatan"
            rules-text="Required"
            :validationData="validate.jabatan"
          >
            <input
              v-model="validate.jabatan.$model"
              placeholder="Jabatan"
              class="form-control"
              :class="{
                'border-theme-6': validate.jabatan.$error,
              }"
            />
          </form-item>
          <form-item
