<template>
  <document-form title="Akta Pendirian" v-loading="legalitasLoading">
    <div class="pb-5 pt-3">
      <div class="grid grid-cols-12 gap-5">
        <div class="col-span-6">
          <form-item
            ...
            label="Nomor Akta" 
            rules-text="Required"
            :validationData="validate.nomor_akta"
          >
            <input
              v-model="validate.nomor_akta.$model"
              placeholder="Nomor Akta"
              class="form-control"
              :class="{
                'border-theme-6': validate.nomor_akta.$error,
              }"
            />
          </form-item>
        </div>
