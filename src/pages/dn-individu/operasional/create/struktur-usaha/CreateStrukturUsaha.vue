<template>
  <div class="grid grid-cols-12 gap-6">
    ...
    <div class="col-span-12 lg:col-span-8">
      <!-- Struktur Usaha -->
      <document-form title="Struktur Usaha" v-loading="loading" :itemType="2">
        <div>
          <div class="p-5">
            <div class="grid grid-cols-2 gap-5">
              <form-item
                class="intro-y"
                label="Struktur Usaha"
                rules-text="Required"
                :validationData="validate.struktur_usaha"
              >
                <el-upload
                  ref="elUpload"
              ...
              >
                <input
                  v-model="validate.jumlah_karyawan.$model"
                  placeholder="Jumlah Karyawan"
                  class="form-control"
                  :class="{
                    'border-theme-6': validate.jumlah_karyawan.$error,
                  }"
                />
              </form-item>
            </div>
...
export default defineComponent({
  components: { DocumentForm, DataGrid, FormItem, DNNav, TenagaPemasaran },
  setup() {
    const formData = reactive({ ...formDataDefaults });
    const rules = {
      struktur_usaha: { required },
